...
function delete_azure_image() {
    ...
    RESOURCE_GROUP=$(terraform -chdir=terraform/bootstrap/azure output -raw packer_shared_image_gallery_resource_group)
    SHARED_IMAGE_GALLERY=$(terraform -chdir=terraform/bootstrap/azure output -raw packer_shared_image_gallery)
    IMAGE_DEFINITION=$(terraform -chdir=terraform/bootstrap/azure output -raw centos_image_definition)
    ...
    _information "Retrieving Azure Shared Image Gallery Details..."
    RESOURCE_GROUP=$(terraform -chdir=terraform/bootstrap/azure output -raw packer_artifacts_resource_group)
    SHARED_IMAGE_GALLERY=$(terraform -chdir=terraform/bootstrap/azure output -raw packer_shared_image_gallery)
    IMAGE_DEFINITION=$(terraform -chdir=terraform/bootstrap/azure output -raw centos_image_definition)
    _success "Retrieved Azure Shared Image Gallery Details"
